      ...
      >
        ...
        >
          ...
          >
            <Typography variant="body1" align="justify">
              PerfectCircle regroupe des praticiens, des coachs et des thérapeutes partageant les valeurs de PerfectCenter.<br />
          ...
          <div style={{ width: "100%", display: "flex", alignContent: "center", justifyContent: "center", flexDirection: "column", margin: "0 0 2rem 0" }}>
            ...
            <div style={{ margin: "2rem 0 0 0", padding: "0 0.5rem" }}>
              <Carousel slides={slidesCoaches} options={carouselOptions} autoplay={autoplayOptions} autoheight={autoHeightOptions} />
            </div>
          </div>
        </Grid>
        ...
        <div style={{ width: "100%", display: "flex", flexDirection: "column", alignContent: "center", alignItems: "center", justifyContent: "center", padding: "0 3vw" }}>
          <Typography variant="body1" align="justify">
            ...
            Vous profiterez d&apos;un environnement convivial, productif et enrichissant.<br /><br />
            Télécharger notre brochure des différents avantages à être membre ici.<br /><br />
