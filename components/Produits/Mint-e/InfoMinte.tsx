  ...
  return (
    <>
      ...
      >
        ...
        <ImageAndDescription position='right'titre="Produciton en auvergne et provence" description="Une fois les ingrédients récoltés, ils sont acheminés non loin de leur lieu de production, vers nos laboratoires, où ils sont transformés selon des formulations minutieusement mises au point durant de longues années de recherche." photo='/picto/rhone_alpe.png' />
        </div>
        <div
            style={{
            width: '100%',
