    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <a href={props.user?.facebook} target="_blank" rel="noreferrer">
              <img
                src="picto/Facebook_fonce.png"
                width={40}
                style={{
            ...
            <a href={props.user?.instagram} target="_blank" rel="noreferrer">
              <img
                src="picto/Instagram_fonce.png"
                width={40}
                style={{
            ...
            <a href={props.user?.linkedin} target="_blank" rel="noreferrer">
              <img
                src="picto/Linkedin_fonce.png"
                width={40}
                style={{
