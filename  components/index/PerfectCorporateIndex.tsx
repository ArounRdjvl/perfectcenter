                ...
                >
                    <div
                        style={{
                            ...
                            />
                            <Typography variant="h3" color="textSecondary" style={{margin: "1rem 0 0 0"}}>Offres entreprise</Typography>
                    </div>
                </Grid>
                <Grid
                    xs={12}
                    ...
                    <div
                        style={{
                            ...
                            <img
                                ...
                                style={{marginTop: "1rem"}}
                            />
                            <Typography variant="h3" color="textSecondary" style={{margin: "1rem 0 0 0"}}>Offres entreprises</Typography>
                    </div>
                </Grid>
            </Grid>
    )
