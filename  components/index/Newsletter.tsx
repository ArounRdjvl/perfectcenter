...
export function Newsletter() {
    ...
    if(isMobile) {
        ...
        >
            ...
            />
            <Button variant="contained" color="secondary" size="large" onClick={submitForm} style={{width: "40%", fontSize:"20px"}} >
                Inscription
            </Button>
        </div>
        )
    ...
    return (
        ...
        >
            ...
            <Button variant="contained" color="secondary" size="large" onClick={submitForm} style={{width: "30%", fontSize:"20px"}} >
                Inscription
            </Button>
        </div>
    )
