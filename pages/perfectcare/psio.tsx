    ...
    return (
        <div ref={ref}>
            ...
            <div style={{
                ...
                <BulleInfo titre="Gestion des émotions" size="10rem" photoUrl="/picto/Gestion_emotions.png" photoSize="50%"/>
                ...
                <BulleInfo titre="Dépression" size="10rem" photoUrl="/picto/Depression.png" photoSize="50%"/>
                <BulleInfo titre="Addiction" size="10rem" photoUrl="/picto/Addiction.png" photoSize="60%"/>
                <BulleInfo titre="Mémoire et apprentissage" size="10rem" photoUrl="/picto/Apprentissage.png" photoSize="60%"/>
            </div>
            <Container>
                <LumiereMusique />
            </Container>
