...
export const dataProducts = [
  {
    ...
    desc: (
      <>
        Utilisant la technologie de la stimulation sensorielle, les lunettes de lumino-relaxation
        PSIO garantissent des effets durables sur des problèmes tels que :
        <br /> - Le stress
        <br /> - La fatigue
        ...
        <br />
        C’est une solution innovante, simple et efficace à toute personne désireuse d’améliorer sa
  ...
  },
  {
    ...
    desc: (
      <>
        Mint-e propose une gamme de produits appréciée pour son efficacité. <br />
        <br /> Elle est conseillée par de nombreux médecins, thérapeutes et centre hospitaliers
        comme le Centre Léon Bérard à Lyon (Centre Régional de Lutte contre le Cancer) mais aussi
        par des sportifs de haut niveau. <br />
        <br /> Mint-e associe la phytothérapie, les Fleurs de Bach et des dilutions
