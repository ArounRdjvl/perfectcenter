...
export const dataProducts = [
  {
    ...
    desc: (
      <>
        Les lunettes de lumino-relaxation PSIO garantissent des effets durables sur des problèmes
        tels que le stress, la fatigue, le dysfonctionnement corporel, la dépression, la gestion des
        émotions..
        <br />
  ...
  },
  {
    ...
    desc: (
      <>
        Mint-e propose une gamme de produits appréciée pour son efficacité. Elle est conseillée par
        de nombreux médecins, thérapeutes et centre hospitaliers.
